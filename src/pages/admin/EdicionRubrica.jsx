...
const fetchCreateTitulo = async () => {
  ...
  try {
    const response = await fetch(`https://api-omega-amber.vercel.app/titulos/${rubricaId}`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
...
const fetchCreateCasos = async (tituloId) => {
  ...
  try{
    ...
    const response = await fetch(`https://api-omega-amber.vercel.app/casos/${tituloId}`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
...
try{
    const response = await fetch(`https://api-omega-amber.vercel.app/puntos/${casoId}`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
